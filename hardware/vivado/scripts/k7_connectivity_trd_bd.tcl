...
proc create_hier_cell_gen_chk { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 Op1
  create_bd_pin -dir O axi_stream_c2s_tvalid
  ...
  set xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.0 xlconcat_0 ]
  set_property -dict [ list CONFIG.IN0_WIDTH {16} CONFIG.IN1_WIDTH {4}  ] $xlconcat_0

  # Create instance: xlconcat_1, and set properties
  set xlconcat_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.0 xlconcat_1 ]
  ...
  connect_bd_net -net axi_stream_gen_check_0_axi_stream_c2s_tvalid1 [get_bd_pins axi_stream_c2s_tvalid] [get_bd_pins axi_stream_gen_check_0/axi_stream_c2s_tvalid]
  ...
  connect_bd_net -net axi_stream_gen_check_1_axi_stream_c2s_tvalid1 [get_bd_pins axi_stream_c2s_tvalid1] [get_bd_pins axi_stream_gen_check_1/axi_stream_c2s_tvalid]
...
proc create_hier_cell_PCIe_Path { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.Bar0_Size {64} CONFIG.Buf_Opt_BMA {true} CONFIG.Device_ID {7082} CONFIG.Link_Speed {5.0_GT/s} CONFIG.Maximum_Link_Width {X8} CONFIG.Ref_Clk_Freq {100_MHz} CONFIG.Xlnx_Ref_Board {KC705_REVC} CONFIG.en_ext_ch_gt_drp {false} CONFIG.en_ext_clk {false} CONFIG.en_ext_gt_common {false} CONFIG.en_transceiver_status_ports {false} CONFIG.mode_selection {Advanced} CONFIG.pipe_sim {false} CONFIG.shared_logic_in_core {false}  ] $pcie_7x_0
...
proc create_hier_cell_Ethernet_Path { parentCell nameHier } {
  ...
  set ten_gig_eth_mac_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_mac:13.1 ten_gig_eth_mac_0 ]

  # Create instance: ten_gig_eth_mac_1, and set properties
  set ten_gig_eth_mac_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_mac:13.1 ten_gig_eth_mac_1 ]

  # Create instance: ten_gig_eth_pcs_pma_0, and set properties
  set ten_gig_eth_pcs_pma_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_pcs_pma:4.1 ten_gig_eth_pcs_pma_0 ]

  # Create instance: ten_gig_eth_pcs_pma_1, and set properties
  set ten_gig_eth_pcs_pma_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_pcs_pma:4.1 ten_gig_eth_pcs_pma_1 ]
...
proc create_hier_cell_DDR_Memory { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.axis_tdata_width {512} CONFIG.dram_base_addr {00000000} CONFIG.enable_interrupt {true} CONFIG.number_of_channel {4} CONFIG.number_of_page_ch0 {1024} CONFIG.number_of_page_ch1 {1024} CONFIG.number_of_page_ch2 {1024} CONFIG.number_of_page_ch3 {1024}  ] $axi_vfifo_ctrl_0
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_stream_gen_check_0_axi_stream_c2s [get_bd_intf_pins PCIe_Path/c2s0_perf] [get_bd_intf_pins gen_chk/axi_stream_c2s]
...
connect_bd_intf_net -intf_net pcie_7x_0_pcie_cfg_fc [get_bd_intf_pins PCIe_Path/pcie_cfg_fc] [get_bd_intf_pins nwl_backend_dma_x8g2_0/cfg_fc]
  ...
  connect_bd_net -net axi_stream_gen_check_0_axi_stream_c2s_tvalid1 [get_bd_pins PCIe_Path/axi_str_c2s0_tvalid_perf] [get_bd_pins gen_chk/axi_stream_c2s_tvalid]
  ...
  connect_bd_net -net axi_stream_gen_check_1_axi_stream_c2s_tvalid1 [get_bd_pins PCIe_Path/axi_str_c2s1_tvalid_perf] [get_bd_pins gen_chk/axi_stream_c2s_tvalid1]
