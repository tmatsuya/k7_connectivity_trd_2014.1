...
#
##add_files -norecurse ../runs/k7_connectivity_trd.srcs/sources_1/ip/mig_axi_mm/mig_axi_mm/example_design/sim/ddr3_model.v
#set_property include_dirs {../../sources/testbench/include ../../sources/testbench} [get_filesets sim_1]
##set_property USED_IN simulation [get_files ../runs/k7_connectivity_trd.srcs/sources_1/ip/mig_axi_mm/mig_axi_mm/example_design/sim/ddr3_model.v] 
